...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41048 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41048(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41054 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41054(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41059 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41059(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41066 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41066(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41069 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41069(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41075 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41075(reader);
}
});
...
var G__41217 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41218 = s.append(c);
c = G__41217;
s = G__41218;
continue;
}
