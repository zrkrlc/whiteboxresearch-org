...
var G__51375 = o;
reagent.impl.template.goog$module$goog$object.set(G__51375,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__51393__delegate = function (args){
...
while (G__51394__i < G__51394__a.length) {G__51394__a[G__51394__i] = arguments[G__51394__i + 0]; ++G__51394__i;}
  args = new cljs.core.IndexedSeq(G__51394__a,0,null);
} 
return G__51393__delegate.call(this,args);};
G__51393.cljs$lang$maxFixedArity = 0;
G__51393.cljs$lang$applyTo = (function (arglist__51395){
var args = cljs.core.seq(arglist__51395);
return G__51393__delegate(args);
});
...
var G__51376 = o;
reagent.impl.template.goog$module$goog$object.set(G__51376,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__51396__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__51397__i < G__51397__a.length) {G__51397__a[G__51397__i] = arguments[G__51397__i + 0]; ++G__51397__i;}
  args = new cljs.core.IndexedSeq(G__51397__a,0,null);
} 
return G__51396__delegate.call(this,args);};
G__51396.cljs$lang$maxFixedArity = 0;
G__51396.cljs$lang$applyTo = (function (arglist__51398){
var args = cljs.core.seq(arglist__51398);
return G__51396__delegate(args);
});
...
var G__51377 = props;
var G__51377__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51377,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51377);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51377__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__51378 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51378,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__51378;
}
})(),id_class);
...
var G__51379 = (cljs.core.count(argv) - first_child);
switch (G__51379) {
case (0):
...
var vec__51380 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51380,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51380,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51380,(2),null);
...
var temp__5757__auto___51400 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___51400 == null)){
} else {
var key_51401 = temp__5757__auto___51400;
(jsprops.key = key_51401);
}
...
var temp__5757__auto___51402 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___51402 == null)){
} else {
var key_51403 = temp__5757__auto___51402;
(jsprops.key = key_51403);
}
...
var temp__5757__auto___51404 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___51404 == null)){
} else {
var key_51405 = temp__5757__auto___51404;
(jsprops.key = key_51405);
}
...
var temp__5757__auto___51406 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___51406 == null)){
} else {
var key_51407 = temp__5757__auto___51406;
(jsprops.key = key_51407);
}
...
var temp__5757__auto___51408 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___51408 == null)){
} else {
var key_51409 = temp__5757__auto___51408;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51383_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__51383_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__51384 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51384,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51384,(1),null);
...
break;
default:
var G__51411 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__51412 = compiler;
v = G__51411;
compiler = G__51412;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template51390 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template51390 = (function (opts,id,fn_to_element,parse_fn,meta51391){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template51390.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_51392,meta51391__$1){
var self__ = this;
var _51392__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template51390(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta51391__$1));
}));

(reagent.impl.template.t_reagent$impl$template51390.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_51392){
var self__ = this;
var _51392__$1 = this;
return self__.meta51391;
}));

(reagent.impl.template.t_reagent$impl$template51390.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template51390.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template51390.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template51390.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template51390.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template51390.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta51391","meta51391",343128972,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template51390.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template51390.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template51390");

(reagent.impl.template.t_reagent$impl$template51390.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template51390");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template51390.
 */
reagent.impl.template.__GT_t_reagent$impl$template51390 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template51390(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta51391){
return (new reagent.impl.template.t_reagent$impl$template51390(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta51391));
});

}

return (new reagent.impl.template.t_reagent$impl$template51390(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
